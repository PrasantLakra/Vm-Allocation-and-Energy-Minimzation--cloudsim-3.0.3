...
public abstract class PowerVmAllocationPolicyMigrationAbstract extends PowerVmAllocationPolicyAbstract {
	...
	// SJF
		public PowerHost findHostForVm(Vm vm, Set<? extends Host> excludedHosts) {
		    ...
		    for (PowerHost host : this.<PowerHost>getHostList()) {
		        ...
		        if (host.isSuitableForVm(vm)) {
		            double completionTime = estimateCompletionTime(host, vm);
		...
		// Assuming these methods exist to manage the index of the last allocated host
		private int getLastAllocatedHostIndex() {
		    // Implement logic to retrieve the last allocated host index (from storage or default to 0)
		    // ...
		    return 0;
		}

		private void setLastAllocatedHostIndex(int index) {
		    // Implement logic to update and store the last allocated host index
		    // ...
		}
